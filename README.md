# nyx-api
API that provides various endpoints for fun, images, and Discord integrations, specifically for [NYX](https://github.com/night0721/cath.exe)
...
# License
This project is licensed under the GNU Public License v3.0. See [LICENSE](https://github.com/night0721/nyx-api/blob/master/LICENSE) for more information.